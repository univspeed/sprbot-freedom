package com.cybercloud.sprbotfreedom.platform.util.json;
...
public class JsonObject extends LinkedHashMap<String, Object> {
    ...
    public static boolean isJson(Object content) {
        ...
        boolean isJsonArray = true;
        try {
            JSONObject.parseObject(JSONObject.toJSONString(content));
        } catch (Exception e) {
            isJsonObject = false;
        }
        try {
            JSONObject.parseArray(JSONObject.toJSONString(content));
        } catch (Exception e) {
            isJsonArray = false;
        }
        //不是json格式
