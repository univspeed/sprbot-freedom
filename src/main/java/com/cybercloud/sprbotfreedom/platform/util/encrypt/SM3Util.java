...
public class SM3Util {
    ...
    public static String createSM3(String str)   {

        try {
            return SM3Util.byteArrayToHexString(SM3Util.hash(str.getBytes()));
        } catch (IOException e) {
            log.error("{}",e);
        }
        return null;
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("admin:    "+ SM3Util.createSM3("admin-sLJ0elFH3rVclTg5PKu5Pw==-W0shimim@"));
    }
}
